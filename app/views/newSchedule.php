...
<head>
	...
	<link rel="stylesheet" href="public/css/newSchedule.css">
			...
			<!-- <form onSubmit="return submitPlan()" id="programplanningworksheet"> -->
				...
				<div id="coursesearchsection" style="display:inline-block; margin-top:20px; width:100%;">
					<div style="display:inline-block;">
						<label for="course">Search for a course <br>
							<font size="1">enter a subject, course number, title or credits</font>
						</label><br>
